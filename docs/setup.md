...
- A random 6-character hex suffix is appended to repo names to prevent collisions, but a duplicate is still theoretically possible
- GitHub returns 422 Unprocessable Entity for duplicate repo names
- If this occurs, the user can simply retry their tweet
